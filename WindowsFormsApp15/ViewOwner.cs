    ...
    public partial class ViewOwner : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                add.User_id = Form1.SetValueForText1;
                db.Houses.Add(add);
                db.SaveChanges();
        ...
        {
            var aa = Form1.SetValueForText1;
            dataGridView1.DataSource = db.Houses.Where(s => s.User_id == aa ).ToList();
            comboBox1.Items.Add("yes");
            comboBox1.Items.Add("no");

            var check = db.Houses.Where(s => s.User_id == Form1.SetValueForText1).Select(s=>s.id).ToList();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                house.User_id = Form1.SetValueForText1;
